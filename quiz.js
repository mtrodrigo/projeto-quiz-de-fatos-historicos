...
let nome_usuario = dados.question("Digite seu nome: ")
...
function embaralharArray(colecaoPerguntas) {
  ...
  function exibirPerguntas(colecaoPerguntas) {
    colecaoPerguntas.forEach((pergunta, index) => {
      ...
      let respostaUsuario = dados.question("Qual sua resposta (ano): ")
  ...
  console.log(`Parabens ${nome_usuario} você finalizou o quiz!`);
  console.log(`Você errou: ${respostasErradas} perguntas`);
  if(respostasCorretas === 10){
    console.log(`Voce acertou ${respostasCorretas} pergutas`);
    console.log(`EXCELENTE! Você é um verdadeiro expert.`);
  }
  else if(respostasCorretas <= 9 && respostasCorretas >= 7){
    console.log(`Voce acertou ${respostasCorretas} pergutas`);
    console.log(`MUITO BOM! Você acertou a maioria.`);
  }
  else if(respostasCorretas <= 6 && respostasCorretas >= 4){
    console.log(`Voce acertou ${respostasCorretas} pergutas`);
